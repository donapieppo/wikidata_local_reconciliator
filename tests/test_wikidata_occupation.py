...
class TestOccupation(unittest.TestCase):
    def test_add_occupation(self):
        occupation.add_occupation('pippo', 'Q12121212')
        self.assertEqual(occupation.get_name_by_qcode('Q12121212'), 'pippo')
        self.assertEqual(occupation.get_qcode_by_name('pippo'), 'Q12121212')
